...
objective.Mod.Med.Model.0 <- lm(Sharelikelihood ~ group.x*Headline_Veracity.W , data = shifts_attention_exp3)
...
objective.Mod.Med.Model.1 <- lm(reward ~ group.x*Headline_Veracity.W, data = shifts_attention_exp3) 
...
objective.Mod.Med.Model.2 <- lm(Sharelikelihood ~ group.x*Headline_Veracity.W + reward , data = shifts_attention_exp3)
...
objective.Mod.Med.Test.w <- mediate(objective.Mod.Med.Model.1, objective.Mod.Med.Model.2, 
                          boot = TRUE, boot.ci.type = "bca", sims = 5000, 
                          treat="group.x", mediator="reward")
summary(objective.Mod.Med.Test.w)
